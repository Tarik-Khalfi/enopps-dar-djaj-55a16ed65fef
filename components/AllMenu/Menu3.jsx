        ...
        <section className=' relative py-20'>
            <div className='container relative    flex justify-between '>
                ...
                <div className='bg-white mt-[200px] py-10 px-10 z-50 space-y-8 '>
                    <h3 className='text-[#F09804E5]  text-4xl font-bernier font-semibold'>ASSIETTES</h3>
                    ...
                    <div className='text-[#808080] space-y-4'>
                        <div className='w-[400px] '>
                            <div className='flex justify-between items-center'>
                                <p className='font-medium text-2xl font-bernier  text-[#0F1622]'>ESCALOPE DE POULET</p>
                                <p className=' text-primary'>--------------------------</p>
                    ...
                    <div className='text-[#808080] space-y-4'>
                        <div className='w-[400px] '>
                            <div className='flex justify-between items-center'>
                                <p className='font-medium text-2xl font-bernier  text-[#0F1622]'>EMINCE DE POULET</p>
                                <p className=' text-primary'>------------------------------</p>
                    ...
                    <div className='text-[#808080] space-y-4'>
                        <div className='w-[400px] '>
                            <div className='flex justify-between items-center'>
                                <p className='font-medium text-2xl font-bernier  text-[#0F1622]'>BROUCHETTES DE POULET</p>
                                <p className=' text-primary'>---------------------</p>
