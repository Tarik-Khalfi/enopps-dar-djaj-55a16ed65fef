    ...
    <section className="bg-[#0D1518]   py-[140px]">
      <div className="container relative  flex justify-between items-center">
        <div className="bg-white  py-10 px-10 z-50 space-y-4 ">
          <h3 className="text-[#F09804E5]  text-6xl font-bernier font-semibold">
            Salade
          </h3>
          ...
          <div className="text-[#808080] space-y-4">
            <div className="w-[400px] ">
              <div className="flex justify-between items-center">
                <p className="font-normal text-2xl font-bernier  text-[#0F1622]">
                  Salade niçoise
                </p>
              ...
              <p className="text-[#808080] font-500 text-[14px] leading-[27px] font-poppins ">
                Pomme de terre, bettrave, carotte, riz, thon, oeuf , concombre,
                olive
              </p>
            </div>
          </div>
          ...
          <h3 className="text-[#F09804E5] pt-[20px]  text-2xl font-bernier ">
